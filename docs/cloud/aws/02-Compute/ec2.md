...
- [EC2](#ec2)
  ...
  - [Placements group](#placements-group)
    - [ENI (Elastic Network Interface), IP, and DNS](#eni-elastic-network-interface-ip-and-dns)
    - [EN (Enhanced Network)](#en-enhanced-network)
