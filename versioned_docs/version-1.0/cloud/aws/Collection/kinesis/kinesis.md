...
- [Kinesis](#kinesis)
  - [1. Kinesis Streams](#1-kinesis-streams)
    - [Kinesis Streams Shards](#kinesis-streams-shards)
    - [Limits](#limits)
  - [2. Kinesis Data Firehose (KDF)](#2-kinesis-data-firehose-kdf)
  - [3. Kinesis Data Streams vs Firehose](#3-kinesis-data-streams-vs-firehose)
...
![kinesis_record](../screenshots/kinesis_record.png)
...
![kdf_read_write](../screenshots/kdf_read_write.png)
